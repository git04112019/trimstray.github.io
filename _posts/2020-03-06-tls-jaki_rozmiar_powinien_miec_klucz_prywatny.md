...
Najnowsza wersja [FIPS-186-5 (Draft)]({{ site.url }}/assets/pdfs/FIPS/NIST.FIPS.186-5-draft.pdf) <sup>[FIPS, PDF]</sup> określa zastosowanie modułu, którego długość bitu jest liczbą całkowitą równą 2048-bit lub większą (co ciekawe, starsza wersja, tj. FIPS-186-4 z 2013 roku, mówiła, że rząd federalny USA generuje (i używa) podpisy cyfrowe o długości klucza 1024, 2048 lub 3072 bit).
