...
W tym wpisie chciałbym pomówić o optymalizacji parametrów sesji SSL/TLS (na przykładzie serwera NGINX), ponieważ jest to moim zdaniem jeden z ważniejszych kroków do poprawy ogólnych wrażeń użytkowników podczas korzystania z aplikacji uruchamianych w przeglądarkach internetowych. Pamiętaj jednak, że obsesja na punkcie wartości i skrupulatnego dostrajania parametrów jest zdecydowanie czymś przesadzonym, ponieważ najprawdopodobniej w większości przypadków uzyskamy ledwie delikatny wzrost wydajności, wręcz niezauważalny podczas codziennej pracy. Myślę jednak, że warto mieć świadomość, który parametr, za co odpowiada i jakie niesie konsekwencje jego zmiana oraz ile możemy zyskać po takiej operacji.
