...
Protokół DNS został dokładnie opisany w kilku dokumentach RFC, natomiast najnowsze z nich to [RFC - 1034 - Domain Names - Concepts And Facilities](https://tools.ietf.org/html/rfc1034) oraz [RFC 1035 - Domain Names - Implementation And Specification](https://tools.ietf.org/html/rfc1035). Przeglądając je, znajdziesz w nich odnośniki to starszych wersji.
